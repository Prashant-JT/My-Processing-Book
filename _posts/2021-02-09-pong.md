...
<br>En la función **reset()** se resetean las posición de la pelota, además se decide aleatoriamente en la dirección a la que irá dirigida cuando comience la siguiente ronda, así como en el ángulo al cual apuntará:
...
<br>En el momento el cual el usuario decide empezar o reanudar el juego, se ejecutará la función **startGame()** el cual establecerá los colores de fondo y las palas de ambos jugadores del juego. Se dibuja una línea en el centro del juego con la función **line(x,y,h)** con el fin de diferenciar ambos lados de los jugadores y establecer un centro del campo. Para dibujar las palas se hace uso de la función **rect(x,y,w,h)** al cual se le pasa como parámetros las coordenadas (x, y), anchura y altura del rectángulo. 
...
![](https://github.com/Prashant-JT/My-Processing-Book/blob/master/images/pong/gif-demo.gif)

![](https://i.blogs.es/aa1b9a/luna-100mpx/450_1000.jpg)
