...
<br>La función **checkCollision()** se encarga de detectar si la pelota ha colisionado con la pala de alguno de los jugadores. Si es así, se invierte la dirección de la cooredenada X de la pelota y se reproduce el sonido de rebote, tanto para el jugador 1 como para el jugador 2.
...
Para descargar el código en Processing, puede acceder al enlace del repositorio y descargar la carpeta del proyecto: ![Ver el código en Processing](/My-Processing-Book/projects/pong "Ejecución del código en Processing")
...
[https://www.videvo.net/es/efectos-de-sonido/](Efectos de sonido)
