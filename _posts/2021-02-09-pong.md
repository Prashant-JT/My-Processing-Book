...
Para calcular el ángulo en el cual la pelota se lanzará, se utiliza la funión **random()** pasando como parámetros -pi/4 y pi/4. A continuación, se establece la velocidad del eje X a 3 (la velocidad irá aumentado que se explicarrá más adelante) y se calcula el del eje Y como *5 * sin(ángulo)*.
