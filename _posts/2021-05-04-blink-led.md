...
El diseño y configuración ha sido el que se puede observar en la siguiente figura. Se adjunta el <a href=" https://www.tinkercad.com/things/cknacAsoMJE">enlace de la configuración en Tinkercad</a> para visualizar la configuración y modificar si se desea.

![](/My-Processing-Book/images/blink_led/blink-led-tinkercad-demo.PNG "Diseño, configuración y ejecución del Arduino en Tinkercad")
...
| ![](/My-Processing-Book/images/blink_led/blink-led-serial-demo.gif "Salida del monitor serie") | ![](/My-Processing-Book/images/blink_led/blink-led-arduino-demo.gif "Prueba del código en vivo") |
